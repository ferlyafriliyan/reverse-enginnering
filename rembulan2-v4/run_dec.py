...
for apa in range(10000):
	...
	cih = str(rc([f'Mozilla/5.0 (iPhone; CPU iPhone OS 13_5_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.1.1 Mobile/15E148 Safari/604.1']))
	...
	cih6 = str(rc([f"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Safari/537.36 HeyTapBrowser/45.9.5.1.1"]))
	...
	FIRMANJR = random.choice([cih,cih1,cih2,cih3,cih4,cih5,cih6,cih6,cih8])
	ugen.append(FIRMANJR)
P = '\x1b[1;97m'
M = '\x1b[1;91m'
H = '\x1b[1;92m'
K = '\x1b[1;93m'
...
def baz_anim(berjalan):
        for gas in berjalan + "\n":sys.stdout.write(gas);sys.stdout.flush();time.sleep(0.10)
...
def banner():
	print('''\33[m
UPDATE \x1b[1;92m22/juni/2023
\33[mWA BANG FIRMAN \x1b[1;92m083170597744\x1b[1;91m
...
def menu1():
	...
	os.system('clear')
	ban()
	print(f'{xxx}🤤 1. bokep Jepang')
	print(f'{xxx}🤤 2. vidio okep ')
	print(f'{xxx}🤤 3. kumpulan jepang ')
	helpbas = input(f'{xxx}>> : ')
	if helpbas in ['1']:
		baz_anim(f'     {b}ANDA AKAN DI ALIHKAN KE CROME')
		time.sleep(3.00)
		os.system("xdg-open https://yandex.com/search/touch/?text=bokep+Jepang+&search_source=yacom_touch_common&mda=0&lr=10574")
		back()
	elif helpbas in ['2']:
		baz_anim(f'     {b}ANDA AKAN DI ALIHKAN KE CROME')
		time.sleep(3.00)
		os.system("xdg-open https://yandex.com/video/touch/preview/2838231513663212217")
		back()
	elif helpbas in ['3']:
		baz_anim(f'     {b}ANDA AKAN DI ALIHKAN KE CROME')
		time.sleep(3.00)
		os.system("xdg-open https://yandex.com/video/touch/preview/16361421292055771301")
		back()
	else:
		back()
